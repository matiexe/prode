...
partidosAdminRouter.post('/generar', async (_req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const fechas8vos = [
      ...
      '2026-07-07T00:00:00Z', // P94
      '2026-07-07T16:00:00Z', // P95
      '2026-07-07T20:00:00Z', // P96
    ];
    const fechasCuartos = [
      '2026-07-09T20:00:00Z', // P97
      '2026-07-10T19:00:00Z', // P98
      '2026-07-11T21:00:00Z', // P99
      '2026-07-12T01:00:00Z', // P100
    ];
    const fechasSemis = [
    ...
    const fechas3erPuesto = [
      '2026-07-18T21:00:00Z', // P103
    ];
    const fechasFinal = [
      '2026-07-19T19:00:00Z', // P104
    ];
...
partidosAdminRouter.put('/:id/resultado', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    await propagarProgresoLlave(partido);

    res.json({ mensaje: 'Resultado guardado, puntos calculados y llaves avanzadas', partido });
  } catch (error) {
